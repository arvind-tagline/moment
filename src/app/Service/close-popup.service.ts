...
export class ClosePopupService {
  ...
  //load more data on scroll start
  ...
  //   if (this.categories.length >= this.data.value.length) {
  //     return false;
  //   }
  //   const remainingLength = Math.min(30, this.data.value.length - this.categories.length);
  //   this.categories.push(...this.data.value.slice(this.categories.length, this.categories.length + remainingLength));
  //   return true;
  // }
